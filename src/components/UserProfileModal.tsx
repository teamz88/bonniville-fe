      ...
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        <Card className="border-0 shadow-none">
          ...
          <CardContent className="space-y-8">
            ...
            {(user.total_tokens_used || user.input_tokens_used || user.output_tokens_used) && (
              <div className="border-t pt-6">
                <h3 className="text-lg font-semibold flex items-center gap-2 mb-4">
                  <Building className="w-5 h-5" />
                  Token Usage
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {user.total_tokens_used && (
                    <div>
                      ...
                      <p className="text-gray-900">{user.total_tokens_used.toLocaleString()}</p>
                    </div>
                  )}
                  {user.input_tokens_used && (
                    <div>
                      <label className="text-sm font-medium text-gray-500">Input Tokens</label>
                      <p className="text-gray-900">{user.input_tokens_used.toLocaleString()}</p>
                    </div>
                  )}
                  {user.output_tokens_used && (
                    <div>
                      <label className="text-sm font-medium text-gray-500">Output Tokens</label>
                      <p className="text-gray-900">{user.output_tokens_used.toLocaleString()}</p>
                    </div>
                  )}
                </div>
              </div>
